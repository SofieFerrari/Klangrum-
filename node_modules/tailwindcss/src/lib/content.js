...
import { parseGlob } from 'tailwindcss/src/util/parseGlob.js'
import { env } from 'tailwindcss/src/lib/sharedState.js'

/** @typedef {import('tailwindcss/types/config.js').RawFile} RawFile */
/** @typedef {import('tailwindcss/types/config.js').FilePath} FilePath */
