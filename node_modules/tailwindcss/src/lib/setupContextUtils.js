...
import transformThemeValue from 'tailwindcss/src/util/transformThemeValue.js'
import parseObjectStyles from 'tailwindcss/src/util/parseObjectStyles.js'
import prefixSelector from 'tailwindcss/src/util/prefixSelector.js'
import isPlainObject from 'tailwindcss/src/util/isPlainObject.js'
import escapeClassName from 'tailwindcss/src/util/escapeClassName.js'
import nameClass, { formatClass } from 'tailwindcss/src/util/nameClass.js'
import { coerceValue } from 'tailwindcss/src/util/pluginUtils.js'
import { variantPlugins, corePlugins } from 'tailwindcss/src/corePlugins.js'
import * as sharedState from 'tailwindcss/src/lib/sharedState.js'
import { env } from 'tailwindcss/src/lib/sharedState.js'
import { toPath } from 'tailwindcss/src/util/toPath.js'
import log from 'tailwindcss/src/util/log.js'
import negateValue from 'tailwindcss/src/util/negateValue.js'
import isSyntacticallyValidPropertyValue from 'tailwindcss/src/util/isSyntacticallyValidPropertyValue.js'
import { generateRules, getClassNameFromSelector } from 'tailwindcss/src/lib/generateRules.js'
...
import { finalizeSelector, formatVariantSelector } from 'tailwindcss/src/util/formatVariantSelector.js'
